var storyLine = [
	{
		story: 'It is the first day of June, 2013, you push through giant square doors with the clanging of the school bell in your ear. You victoriously emerge to the clear blue sky as another year of chalkboards, notebooks, and gym class has come to end.  There is only one way to celebrate this momentous occasion, a {{models.Adventure.adventure_verbiage1}} from {{models.Customer.cust_name}}!  You rush to your bike with excitement, hopping on and kicking the pedals into gear while rolling straight for the Brushy Bush Trail.  Just before you start your journey into the hollow, you happen to glance down and notice a very strange box.  You walk to the box and push away the leaves to find it covered with a strange writing that you' + "'" + 've never seen before.  It was at that moment a bullfrog-like grumble roiled in your stomach...'
...
var choiceAnswers = [
	...
	},
	{
		...
		true: "It was at that moment, you feel your leg begin to heat up and you look down at the bulge in your pocket.  &ldquo;The artifact!&rdquo; you say to yourself as you reach in and wrap your fingers around the object.  You pull it out and it is now shining as bright as a star.  In an instant, the light seems to stream out of the object like an outreaching hand and completely cover the monster.  As you expect the worse, you hear the whimper of a small dog.  You open your eyes to see your neighbor" + "'" + "s missing pug, Mr. Jinks.  It looks at you quizzically and lets out a small bark as it takes off back into the woods towards your neighborhood.  &ldquo;Now I" + "'" + "m really confused&rdquo; you say to yourself as you stand back up and continue on to {{models.Customer.cust_name}}."
	}
];
